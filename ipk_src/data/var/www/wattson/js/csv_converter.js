function createCsv(config) {
    ...
    if (config.virtualMeters.enabled) {
        csv += `gConfig.typConnectionConfig.sWattsOnHostServer;STRING;'${config.virtualMeters.host}'\r\n`
        csv += `gConfig.typConnectionConfig.sWattsOnPassword;STRING;'${config.virtualMeters.password}'\r\n`
        csv += `gConfig.typConnectionConfig.xWattsOnSecure;BOOL;${(config.virtualMeters.secure)?'TRUE':'FALSE'}\r\n`
        csv += `gConfig.typConnectionConfig.xWattsOnOnlyPriority;BOOL;${(config.virtualMeters.onlyPriority)?'TRUE':'FALSE'}\r\n`
        csv += `gConfig.typConnectionConfig.xWattsOnConnectionErrorReboot;BOOL;${(config.virtualMeters.rebootOnError)?'TRUE':'FALSE'}\r\n`
        csv += `gConfig.typConnectionConfig.typWattsOnSSL_Options.sCA_Cert;STRING;'${config.virtualMeters.sslconf.caCert}'\r\n`
        csv += `gConfig.typConnectionConfig.typWattsOnSSL_Options.sCA_Path;STRING;'${config.virtualMeters.sslconf.caPath}'\r\n`
        csv += `gConfig.typConnectionConfig.typWattsOnSSL_Options.xVerifyPeer;BOOL;${(config.virtualMeters.sslconf.verifyPeer)?'TRUE':'FALSE'}\r\n`
        csv += `gConfig.typConnectionConfig.typWattsOnSSL_Options.xVerifyHost;BOOL;${(config.virtualMeters.sslconf.verifyHost)?'TRUE':'FALSE'}\r\n`
        csv += `gConfig.typConnectionConfig.typWattsOnSSL_Options.sClientCert;STRING;'${config.virtualMeters.sslconf.clientCert}'\r\n`
        csv += `gConfig.typConnectionConfig.typWattsOnSSL_Options.sClientCert_Key;STRING;'${config.virtualMeters.sslconf.clientCertKey}'\r\n`
        csv += `gConfig.typConnectionConfig.typWattsOnSSL_Options.sClientCert_KeyPasswd;STRING;'${config.virtualMeters.sslconf.clientCertKeyPasswd}'\r\n`
        for (let vm_index = 1; vm_index - 1 < config.virtualMeters.meters.length; vm_index++) {
            ...
            csv += `gConfig.typVirtualMeterConfig.aVirtualMeterUUIDs[${vm_index}];STRING(36);'${virtualMeter.wattson_uuid}'\r\n`
